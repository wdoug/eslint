...
class ConfigArray extends Array {
    constructor(...args) {
        ...
        /**
         * The base path to find plugins.
         * This property will be set by `ConfigArrayFactory`.
         * @type {string | undefined}
         */
        this.pluginBasePath = void 0;

        Object.defineProperty(this, "pluginBasePath", { enumerable: false });
    }
