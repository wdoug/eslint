 ...
 * @property {string|undefined} initialPluginBasePath The initial plugin base path.
...
class CascadingConfigArrayFactory {
    ...
    constructor({
        ...
        const configArrayFactory = new ConfigArrayFactory({
            ...
            cwd,
            resolvePluginsRelativeTo: initialPluginBasePath
        });
     ...
     */
    getConfigArrayForFile(filePath) {
        const { cwd, initialPluginBasePath } = internalSlotsMap.get(this);
        ...
        return this._finalizeConfigArray(
            this._loadConfigInAncestors(directoryPath, initialPluginBasePath),
            directoryPath
        );
    }
    ...
    _loadConfigInAncestors(directoryPath, providedPluginBasePath) {
        ...
        configArray.pluginBasePath = pluginBasePath;
     ...
     */
    _getBaseConfigArray(providedPluginBasePath) {
        const {
            baseConfigArrayCache,
            baseConfigData,
            configArrayFactory,
        ...
        const pluginBasePath =
            providedPluginBasePath || initialPluginBasePath || cwd;
     ...
     */
    _getCLIConfigArray(providedPluginBasePath) {
        const {
            cliConfigArrayCache,
            cliConfigData,
            configArrayFactory,
